...
const inputFilePath = './sentences-hsk3-1-v1.json'; // Update with your input file path
const outputFilePath = './sentences-hsk3-1-v1-output-v1.txt';    // Update with your desired output file path
