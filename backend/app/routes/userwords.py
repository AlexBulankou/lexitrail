...
def get_userwords_by_user_and_wordset():
    ...
    try:
        # Query userwords and join recall history for last 3 recall attempts
        ...
        for userword in userwords:
            ...
            # Convert recall histories to dict and include 'is_included'
            recall_histories_data = [
                {
                    ...
                    'is_included': userword.is_included  # Add is_included to recall history
                }
                for rh in recall_histories
            ]

            userword_dict = to_dict(userword)
            userword_dict['recall_histories'] = recall_histories_data
